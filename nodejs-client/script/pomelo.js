...
var initWebSocket = function(url,cb){
    ...
    var onerror = function(event) {
        ...
        logger.info('socket error: ', event);
    };
...
//        setTimeout(function(){
//            entry(_host,_port, _MAC, function(){
        logger.warn(' send is null');
//            });
//        },3000);
    }
};
...
//        console.info('heartbeatInterval = %j, heartbeatTimeout = %j', heartbeatInterval, heartbeatTimeout);
    }
